  ...
  <div class="card">
    ...
    <div class="card-body">
            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_input_katmenu.php" method="POST">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" name="input_katmenu_validate" value="12345">Tambah</button>
                </div>
              </form>
            </div>
          </div>
      ...
      ?>
        ...
        <!-- Modal Edit-->
        <div class="modal fade" id="ModalEdit<?php echo $row['id_kat_mn'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-xl modal-fullscreen-md-down">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <!-- Modal Delete-->
        <div class="modal fade" id="ModalDelete<?php echo $row['id_kat_mn'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                  <td class="d-flex">
                    <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id_kat_mn'] ?>"><i class="bi bi-pencil-square"></i></button>
                    <button class="btn btn-danger btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_kat_mn'] ?>"><i class="bi bi-trash"></i></button>
                  </td>
                </tr>
              <?php
              }
